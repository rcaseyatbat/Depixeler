                ...
                (downIndex == -1 && rightIndex == -1))
            {
                for (int xPixel = 0; xPixel < 3; xPixel++) {
                    for (int yPixel = 0; yPixel < 3; yPixel++) {
                        ...
                        color[3*y + yPixel][3*x + xPixel][1] = int(gData[index + 1]);
                        color[3*y + yPixel][3*x + xPixel][2] = int(gData[index + 2]);
                        color[3*y + yPixel][3*x + xPixel][3] = int(gData[index + 2]);
                    }
                }
            }
                ...
                if ((D == H && E != J) || (H == F && E != G)) {
                    color[3*y][3*x + 1][0] = int(H.x);
                    color[3*y][3*x + 1][1] = int(H.y);

                    color[3*y][3*x + 1][2] = int(H.z);
                    color[3*y][3*x + 1][3] = int(gData[downIndex+3]);
                }
                ...
                if ((D == B && E != C) || (B == F && E != A)) {
                    color[3*y + 2][3*x + 1][0] = int(B.x);
                    color[3*y + 2][3*x + 1][1] = int(B.y);

                    color[3*y + 2][3*x + 1][2] = int(B.z);
                    color[3*y + 2][3*x + 1][3] = int(gData[upIndex+2]);
                } 
